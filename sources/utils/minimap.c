...
/*   Updated: 2026/03/24 11:27:22 by mgarnier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mlx_set_image_pixel(mlx->cont, mlx->minimap, mlx->old_pos_x, mlx->old_pos_y,(mlx_color){0});
	mlx_set_image_pixel(mlx->cont, mlx->minimap, mlx->pos_x, mlx->pos_y, (mlx_color)RGB_RED);
	mlx_put_transformed_image_to_window(mlx->cont, mlx->win, mlx->minimap, 10, 10, mlx->zoom, mlx->zoom, 0);
